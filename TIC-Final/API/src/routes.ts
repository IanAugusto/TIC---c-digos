...
    })
    ...
    app.patch('/api/centro_custo/:ID', async (request) => {
        const titleParam = z.object({
            ID: z.string()
        })
    ...
    app.patch('/api/fornecedor/:ID', async (request) => {
        var titleParam = z.object({
            ID: z.string().pipe(z.coerce.number())
        })
    ...
    app.patch('/api/produto/:ID', async (request) => {
        const titleParam = z.object({
            ID: z.string().pipe(z.coerce.number())
        })
    ...
    app.patch('/api/tipo_movimento_estoque/:ID', async (request) => {
        const titleParam = z.object({
            ID: z.string()
        })
    ...
    app.patch('/api/origem_receita/:ID', async (request) => {
        const titleParam = z.object({
            ID: z.string()
        })
        ...
        return await prisma.origem_receita.update({
            where: {
                ID: Number(ID)
            },
            data: {
