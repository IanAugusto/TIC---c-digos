...
import ListProductsSuppliers from '../../components/supplierProducts';
import { useCookies } from 'react-cookie' // hook para manipular cookies
import Login from '../login';

export default function SuppplierProduct() {
    ...
    const titleContent = <div>Associação fornecedores e produtos</div>
    ...
    const mainContent =
        <main>
            <div className="py-4">
                ...
                <CreateModal isOpen={isModalOpen} closeModal={close} type='associationSupplier' />
            </div>
        </main>;
