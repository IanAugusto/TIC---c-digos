...
import ListTypeProducts from '../../components/typeOfProducts';
...
export default function TypeProducts() {
    ...
    const titleContent = <div>Tipos de Produtos</div>
    ...
    const mainContent =
        <main>
            <div className="py-4">
                    ...
                    <table className="min-w-full divide-y divide-gray-300">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" className="py-3.5 pl-4 pr-8 text-left text-sm font-semibold text-gray-900 sm:pl-6">
                                    Controla Validade
                                </th>
                ...
                <CreateModal isOpen={isModalOpen} closeModal={close} type='typeProduct' />
            </div>
        </main>;
