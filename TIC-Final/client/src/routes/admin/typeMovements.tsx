...
import ListTypeMovements from '../../components/typeMovements';
import { useCookies } from 'react-cookie' // hook para manipular cookies
import Login from '../login';

export default function TypeMovements() {
    ...
    const titleContent = <div>Tipos de Movimentação</div>
    ...
    const mainContent =
        <main>
            <div className="py-4">
                ...
                <CreateModal isOpen={isModalOpen} closeModal={close} type='typeMovement' />
            </div>
        </main>;
