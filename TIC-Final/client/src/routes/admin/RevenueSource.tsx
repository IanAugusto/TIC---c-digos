...
import ListRevenueSource from '../../components/revenueSource';
import { Dashboard } from '../../components/sidebar'
import { useState } from 'react'
import { useCookies } from 'react-cookie' // hook para manipular cookies
import Login from '../login';

export default function RevenueSource() {
    ...
    const titleContent = <div>Origem de Receita</div>
        ...
        <main>
            <div className="py-4">
                ...
                <button
                    ...
                    onClick={open}
                >
                    Adicionar um novo Origem de Receita

                </button>
                <CreateModal isOpen={isModalOpen} closeModal={close} type='revenueSource' />
            </div>
        </main>;
